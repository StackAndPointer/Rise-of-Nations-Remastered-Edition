...
// RGB颜色分量结构
struct $FE89DDC12340432DDF8FA85697B05B6D
{
...
// 颜色联合体 - 支持多种颜色表示方式
union $9FDA936D8151E0BAA280E6FA938B4495
{
	$FE89DDC12340432DDF8FA85697B05B6D __s0;  // RGB分量形式
	unsigned int rgb;                        // 32位整型颜色值
};

// 颜色结构 - 完整的颜色表示，支持多种格式
const struct  __declspec(align(4)) Color
{
	$9FDA936D8151E0BAA280E6FA938B4495 ___u0;  // 基础颜色数据
	unsigned __int16 w_555;                   // 16位555格式颜色 (5-5-5 RGB)
	unsigned __int16 w_565;                   // 16位565格式颜色 (5-6-5 RGB)
	unsigned __int8 flags;                    // 颜色标志位
	unsigned __int8 index;                    // 调色板索引
};
